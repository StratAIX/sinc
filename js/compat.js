...
(function () {
  ...
  // ============================================================
  const TYPE_DATA = {
    1:  { nm:'孤独な賢者',   en:'The Quiet Sage',          fam:'Architects' },
    2:  { nm:'一匹狼の開拓者',   en:'The Lone Pioneer',        fam:'Architects' },
    3:  { nm:'誠実な守護者', en:'The Silent Guardian',     fam:'Architects' },
    4:  { nm:'戦略家',         en:'The Strategist',          fam:'Architects' },
    5:  { nm:'影の観察者',     en:'The Shadow Observer',     fam:'Architects' },
    6:  { nm:'陰の野心家',     en:'The Phantom Architect',   fam:'Architects' },
    7:  { nm:'冷静な番人',   en:'The Iron Sentinel',       fam:'Architects' },
    8:  { nm:'黒幕',           en:'The Mastermind',          fam:'Architects' },
    9:  { nm:'詩人',           en:'The Poet',                fam:'Mystics'    },
    10: { nm:'情熱的な芸術家',     en:'The Soul Creator',        fam:'Mystics'    },
    11: { nm:'心の癒し手', en:'The Gentle Healer',       fam:'Mystics'    },
    12: { nm:'夢を形にする人',   en:'The Passionate Builder',  fam:'Mystics'    },
    13: { nm:'漂流者',         en:'The Drifter',             fam:'Mystics'    },
    14: { nm:'孤独な探検家',     en:'The Abyss Walker',        fam:'Mystics'    },
    15: { nm:'心の詩人',       en:'The Shadow Poet',         fam:'Mystics'    },
    16: { nm:'仮面のリーダー',   en:'The Masked Conductor',    fam:'Mystics'    },
    17: { nm:'自由な思想家',   en:'The Free Thinker',        fam:'Commanders' },
    18: { nm:'冒険家',         en:'The Adventurer',          fam:'Commanders' },
    19: { nm:'橋渡し役',         en:'The Mediator',            fam:'Commanders' },
    20: { nm:'指揮官',         en:'The Commander',           fam:'Commanders' },
    21: { nm:'世渡り上手',       en:'The Social Fox',          fam:'Commanders' },
    22: { nm:'策士',           en:'The Tactician',           fam:'Commanders' },
    23: { nm:'クールな外交官',   en:'The Iron Diplomat',       fam:'Commanders' },
    24: { nm:'帝王',           en:'The Emperor',             fam:'Commanders' },
    25: { nm:'太陽',           en:'The Sun',                 fam:'Catalysts'  },
    26: { nm:'燃える革命家',     en:'The Firestarter',         fam:'Catalysts'  },
    27: { nm:'心に寄り添う人',         en:'The Empath',              fam:'Catalysts'  },
    ...
    31: { nm:'表現者',     en:'The Performer',           fam:'Catalysts'  },
